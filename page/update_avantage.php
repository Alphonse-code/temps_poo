...
if (isset($_POST['save'])) {
    ...
    App\Table\Avantage::update_avantage($id,$nom,$montant);
                ...
                <div class="panel-body">
                    <form  method="POST" id="form"  style="width: 90vh;margin-left: 20%;">     
                        <div class="form-group">
                            <label>Nom </label>
                            <input type="text" value="<?=$avtg->getNomAvantage() ?>" class="form-control"  name="nom" >
                        </div>
                        <div class="form-group">
                            <label>Montant de l'avantage </label>
                            <input type="text" value="<?=$avtg->getMontantAvantage() ?>" class="form-control" name="montant">
                        </div>
